...
void loop() {
  ...
  if (Data != "help") {
    bluetooth.print("C1:  ");
    bluetooth.print(red1, HEX);
    bluetooth.print(green1, HEX);
    bluetooth.print(blue1, HEX);
    bluetooth.print("  C2:  ");
    bluetooth.print(red2, HEX);
    bluetooth.print(green2, HEX);
    bluetooth.print(blue2, HEX);
    bluetooth.print("  C3:  ");
    bluetooth.print(red3, HEX);
    bluetooth.print(green3, HEX);
    bluetooth.print(blue3, HEX);
    bluetooth.print("  Waittime:  ");
    bluetooth.print(WT);
...
void serialEvent() {
  while (bluetooth.available()) {
    ...
    red1 = bluetooth.parseInt();
    // do it again:
    green1 = bluetooth.parseInt();
    // do it again:
    blue1 = bluetooth.parseInt();
    if (bluetooth.read() == '\n') {
      return;
    }
    red2 = bluetooth.parseInt();
    // do it again:
    green2 = bluetooth.parseInt();
    // do it again:
    blue2 = bluetooth.parseInt();
    if (bluetooth.read() == '\n') {
      return;
    }
    red3 = bluetooth.parseInt();
    // do it again:
    green3 = bluetooth.parseInt();
    // do it again:
    blue3 = bluetooth.parseInt();
    if (bluetooth.read() == '\n') {
      return;
    }
  }
